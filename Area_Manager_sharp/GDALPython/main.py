...
def main():
    ...
    tiles_folder = '/path/to/your/tiles'  # Укажите путь к вашим тайлам
    summary_file = '/path/to/your/summary.json'  # Укажите путь к вашему summary.json
    ...
    while True:
        ...
        try:
            ...
            if height is None:  # Если высота не найдена
                print("NULL")  # Возвращаем специальное значение для NULL
            else:
                print(height)  # Вывод высоты в stdout
        except Exception as e:
            print(f"ERROR: {e}", file=sys.stderr)  # Возвращаем сообщение об ошибке
